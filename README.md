# `StreamVByte_jll.jl` (v2.0.0+0)

[![deps](https://juliahub.com/docs/StreamVByte_jll/deps.svg)](https://juliahub.com/ui/Packages/General/StreamVByte_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/048d4ee624d34237a8b87f792a7bf012ae6862bd/S/StreamVByte/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `StreamVByte_jll.jl` have been built from these sources:

* git repository: https://github.com/fast-pack/streamvbyte.git (revision: `f27641e3194d14d667e30928a418685d943ab62c`)

## Platforms

`StreamVByte_jll.jl` is available for the following platforms:
